...
- Added section-aware PDF sampling to local summary generation so a fixed context budget covers methods, results, and conclusions instead of only the start of each paper.
