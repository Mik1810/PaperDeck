...
PaperDeck is currently in product definition. The implementation scaffold is not created yet. See [ROADMAP.md](./ROADMAP.md) for the current product and technical plan.
