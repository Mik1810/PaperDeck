...
- Chiusura account Clerk: il webhook verificato usa una sola RPC service-role transazionale per completare successione/rimozione membership prima di eliminare l'identita' collaborativa; migrazione e gate sintetico sono verificati in Development, mentre Production resta un gate separato.
